...
Процедура СпособФормированияСообщенийПриИзмененииНаСервере()
	...
	Для Каждого ИмяСтраницы Из МассивСтраницСпособов Цикл
		ВидимостьСтраницы = СпособФормированияСообщений = Перечисления.EUF_ПроводникСпособыПреобразованияСообщений[ИмяСтраницы];
...
Процедура ВариантОбработчикаПриОтправкеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СписокЗначений.Добавить(
		ПредопределенноеЗначение("Перечисление.EUF_ПроводникВариантыПроизвольногоОбработчика.ВстроенныйОбработчик"),
		"Встроенный обработчик"); 
	СписокЗначений.Добавить(
		ПредопределенноеЗначение("Перечисление.EUF_ПроводникВариантыПроизвольногоОбработчика.ПодключаемыйОбработчик"),
