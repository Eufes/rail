...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Справочники.EUF_ПроводникТипВходящегоСообщения.ИдентификаторТипаВходящегоУникален(ТекущийОбъект, Отказ);
	Если Отказ Тогда
		Возврат;			
	КонецЕсли;	
...
Процедура ДобавитьНастройку()
	...
	ОткрытьФорму("РегистрСведений.EUF_ПроводникИспользуемыеНастройкиДляСообщений.Форма.ФормаЗаписи",
...
&НаКлиенте
Процедура ИспользуемыеНастройкиПриИзменении(Элемент)
	УстановитьПараметрыДинамическихСписков();
КонецПроцедуры
