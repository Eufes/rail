...
Функция ИдентификаторПодключенияУникален(Объект, Отказ) Экспорт
	...
	Если ЗначениеЗаполнено(Объект.ИдентификаторПодключения) Тогда
		...
		|ИЗ
		|	Справочник.EUF_ПроводникПодключенияКВнешнимСистемам КАК ПодключенияКвнешнимСистемам
		|ГДЕ
...
//  СправочникСсылка.EUF_ПроводникПодключенияКВнешнимСистемам, Неопределено - ссылка на элемент, если найден.
//
