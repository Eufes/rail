...
Процедура ДобавитьЗапись(СтруктураЗаписи, Загрузка = Ложь) Экспорт
	...
	MultiPort_ОбщегоНазначения.ДобавитьЗаписьВРегистрСведений(СтруктураЗаписи,
								"MultiPort_ИдентификаторыВнешнихСистем", Загрузка);
...
Функция ЗаписьЕстьВРегистре(СтруктураЗаписи) Экспорт
	...
	|ИЗ
	|	РегистрСведений.MultiPort_ИдентификаторыВнешнихСистем КАК ИДВнешнихСистем
	|ГДЕ
...
Процедура УдалитьЗапись(СтруктураЗаписи, Загрузка = Ложь) Экспорт
	...
	MultiPort_ОбщегоНазначения.УдалитьНаборЗаписейВРегистреСведений(СтруктураЗаписи,
								"MultiPort_ИдентификаторыВнешнихСистем", Загрузка);
...
// 
// Параметры:
//  ВнешняяСистема - ПланОбменаСсылка.MultiPort_ВнешниеСистемы - ссылка на узел плана обмена,
