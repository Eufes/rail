...
Процедура СинхронныйРежимПриИзмененииЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВопроса = КодВозвратаДиалога.Нет Тогда 
		Объект.ОтправлятьСразуПослеОбработки = Ложь;
		Возврат;
	КонецЕсли;
...
Процедура СинхронныйРежимПриИзмененииНаСервере()
	...
	Если Объект.ОтправлятьСразуПослеОбработки Тогда
...
Процедура УстановитьВидимостьДоступность()
	...
	ДоступностьПослеОтправки = Не Объект.ОтправлятьСразуПослеОбработки И Не Объект.ОбрабатыватьРезультатЗапроса;
	...
	Элементы.ВозвращатьОтветВИнтерфейс.Доступность = Объект.ОтправлятьСразуПослеОбработки;
