...
Функция ИдентификаторПроцессаУникален(Объект, Отказ) Экспорт
	...
	|ИЗ
	|	Справочник.MultiPort_ИнтеграционныеПроцессы КАК ИнтеграционныеПроцессы
	|ГДЕ
...
//  СправочникСсылка.MultiPort_ИнтеграционныеПроцессы, Неопределено - ссылка на элемент, если найден.
//
