...
Процедура ОпределитьВыборТиповИзСписка(ДанныеВыбора, СтандартнаяОбработка)
	...
	МассивТипов = Метаданные.ОпределяемыеТипы.EUF_ПроводникОбъектыОбмена.Тип.Типы(); 
	МассивТиповРегистровСведений = Метаданные.ПодпискиНаСобытия.EUF_ПроводникПриЗаписиРегистраСведений.Источник.Типы();
